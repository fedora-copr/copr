...
.. _`They are now documented`: https://docs.copr.fedorainfracloud.org/user_documentation.html#rpm-macros
.. _`known Copr instances`: https://docs.copr.fedorainfracloud.org/user_documentation.html#public-copr-instances
.. _`@pkking`: https://github.com/pkking
.. _`openEuler`: https://www.openeuler.org/en/
.. _`how to reproduce build locally`: https://docs.copr.fedorainfracloud.org/user_documentation/reproducing_builds.html#reproducing-builds
