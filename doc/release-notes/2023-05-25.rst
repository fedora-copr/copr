...
.. _`is now documented`: https://docs.copr.fedorainfracloud.org/user_documentation/pagure_integration.html#auto-rebuilding
.. _`Pagure PR/commit flagging description`: https://docs.copr.fedorainfracloud.org/user_documentation/pagure_integration.html#pr-commit-flagging
.. _`Pagure documentation`: https://docs.copr.fedorainfracloud.org/user_documentation/pagure_integration.html
.. _`SRPM is downloaded only once`: https://docs.copr.fedorainfracloud.org/user_documentation.html#distgit
.. _`Copr architecture`: https://docs.copr.fedorainfracloud.org/developer_documentation/architecture.html
.. _`backup recovery page`: https://docs.copr.fedorainfracloud.org/backup_recovery.html
