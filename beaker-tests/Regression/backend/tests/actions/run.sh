...
rlJournalStart
    rlPhaseStartTest Actions
        ...
        rlAssertEquals "Test that there is no comps.xml file for @actions/test-save-comps/fedora-23-x86_64 through http" `curl -w '%{response_code}' -silent -o /dev/null http://localhost:5002/results/@actions/test-save-comps/fedora-23-x86_64/comps.xml` 404
        rlAssertEquals "Test that there is no module_md.yaml file for @actions/test-save-module_md/fedora-23-x86_64 through http" `curl -w '%{response_code}' -silent -o /dev/null http://localhost:5002/results/@actions/test-save-module_md/fedora-23-x86_64/module_md.yaml` 404
        rlAssertEquals "Test that there is comps.xml file present for @actions/test-delete-comps/fedora-23-x86_64" `curl -w '%{response_code}' -silent -o /dev/null http://localhost:5002/results/@actions/test-delete-comps/fedora-23-x86_64/comps.xml` 200
        rlAssertEquals "Test that there is module_md.yaml file present for @actions/test-delete-module_md/fedora-23-x86_64" `curl -w '%{response_code}' -silent -o /dev/null http://localhost:5002/results/@actions/test-delete-module_md/fedora-23-x86_64/module_md.yaml` 200
        ...
        rlAssertEquals "Test that there is comps.xml file present for @actions/test-save-comps/fedora-23-x86_64" `curl -w '%{response_code}' -silent -o /dev/null http://localhost:5002/results/@actions/test-save-comps/fedora-23-x86_64/comps.xml` 200
        rlAssertEquals "Test that there is module_md.yaml file present for @actions/test-save-module_md/fedora-23-x86_64" `curl -w '%{response_code}' -silent -o /dev/null http://localhost:5002/results/@actions/test-save-module_md/fedora-23-x86_64/module_md.yaml` 200
        rlAssertEquals "Test that there is no comps.xml file present for @actions/test-delete-comps/fedora-23-x86_64" `curl -w '%{response_code}' -silent -o /dev/null http://localhost:5002/results/@actions/test-delete-comps/fedora-23-x86_64/comps.xml` 404
