...
rlJournalStart
    ...
    rlPhaseStartTest
        ...
        rlRun "copr-cli buildmock ${NAME_PREFIX}TestBug1457888 --scm-url https://pagure.io/modularity-testing-framework.git --spec distro/modularity-testing-framework.spec" 0
