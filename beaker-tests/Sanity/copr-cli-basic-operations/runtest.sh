...
rlJournalStart
    ...
    rlPhaseStartTest
        ...
        *) msg_exp="You already have a project named" ;;
        ...
        rlRun "copr_curl $FRONTEND_URL --silent | grep ${NAME_PREFIX}Project7" 1 # project won't be present on hp
        rlRun "copr-cli modify --unlisted-on-hp off ${NAME_PREFIX}Project7"
        rlRun "copr_curl $FRONTEND_URL --silent | grep ${NAME_PREFIX}Project7" 0 # project should be visible on hp now
