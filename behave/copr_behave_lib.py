...
class CoprCli:
    ...
    def dnf_copr_project(self, owner, project):
        """
        Get the full name of a copr project
        """
        # this env is set also for local dev/test stack
        hub = os.environ.get("DNF_COPR_ID", "tested-copr")
        return "{}/{}/{}".format(hub, owner, project)
