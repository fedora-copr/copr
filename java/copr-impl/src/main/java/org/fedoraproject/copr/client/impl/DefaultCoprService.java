 ...
 */
public class DefaultCoprService
    implements CoprService
{
    @Override
    public CoprSession newSession( CoprConfiguration configuration )
    {
        return new DefaultCoprSession( configuration );
    }
}
