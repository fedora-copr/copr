...
%changelog
* Sun Feb 18 2018 clime <clime@redhat.com> 1.0.12-1
- do not generate debuginfo (clime@redhat.com)
- update (clime@redhat.com)
- update (clime@redhat.com)
- update (clime@redhat.com)
- update (clime@redhat.com)
- Update README.md (clime7@gmail.com)
- Update README.md (clime7@gmail.com)
- Update README.md (clime7@gmail.com)
- Update README.md (clime7@gmail.com)
- Update README.md (clime7@gmail.com)
...
- Update README.md (clime7@gmail.com)
- update (clime@redhat.com)
- .copr/Makefile update (clime@redhat.com)
