...
permissions to do so. Finally, instead of just project name, you can also use
project:suffix. In that case, the build will land into a project side repository
instead of the main repository. The side repository of name project:suffix will be
created automatically if it doesn't exist yet. You can e.g. use this feature to
launch test builds while the main user-facing repository stays intact.
