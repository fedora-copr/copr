...
class Build(db.Model, helpers.Serializer):
    ...
    webhook_history_id = db.Column(db.Integer, db.ForeignKey("webhook_history.id"), index=True)
    webhook_history = db.relationship("WebhookHistory", backref=db.backref("builds"))
