...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.coverage', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'sphinx.ext.todo']
...
texinfo_documents = [
  ('index', 'python-copr', u'python-copr Documentation',
   u'copr-devel@lists.fedorahosted.org', 'python-copr', 'Python client for the Copr service',
   'Miscellaneous'),
]
